                                            ...
                                            <form class="form-horizontal auth-form" id="form-login">
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div class="input-group">                                                                                         
                                                        <input type="text" class="form-control" name="username" id="username" placeholder="Digite o seu usuário" required>
                                                    </div>                                    
                                                </div><!--end form-group--> 
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div class="input-group">                                  
                                                        <input type="password" class="form-control" name="password" id="password" placeholder="Digite a sua senha" required>
                                                    </div>                               
                                                </div><!--end form-group--> 
                    
                                                <div class="form-group row my-3">                                                    
                                                    <div class="col-sm-6">
                                                        <a href="./esqueci_senha.php" class="text-muted font-13"><i class="dripicons-lock"></i> Esqueci minha senha</a>                                    
                                                    </div><!--end col--> 
                                                </div><!--end form-group--> 
                    
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12">
                                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit" id="btn_submit">Logar<i class="fas fa-sign-in-alt ms-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->     
        ...
        $.ajax({
            ...
            success: function(data) {                
                ...
                if(result.success){
                    ...
                    msg.fire({ icon: 'success', title: 'Bem-vindo, redirecionando.' }); 
                    
                    if(result.primeiro_acesso) {
                        
                        location.href="primeiro_acesso.php"; 
                        return;                   
                    }
                ...
                msg.fire({ icon: 'error', title: 'Usuário ou senha incorreto.' });
