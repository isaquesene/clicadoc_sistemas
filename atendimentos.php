                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 ms-auto text-end">
                                        ...
                                        <button onclick="gerarConduta()" class="btn btn-primary" style="background: rgba(44, 125, 122, 1);">GERAR CONDUTA</button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-10 ms-auto text-end">
                                        <button class="btn btn-primary" style="border-color: rgba(44, 125, 122, 1); color: rgba(44, 125, 122, 1); background: #fff">NÃO REALIZAR</button>
                                        <a onclick="gerarConduta()" class="btn btn-primary" style="background: rgba(44, 125, 122, 1);">GERAR CONDUTA</a>
                                    </div>
                                </div>
                            </div>                                    
                        </div> <!-- end card-body -->
